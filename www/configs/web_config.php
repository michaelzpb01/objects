...
define('COREFRAME_ROOT','/alidata/www/m.uzhuang.com/coreframe/');//定义核心框架的路径
define('CACHE_ROOT','/alidata/www/m.uzhuang.com/caches/');//缓存文件目录
...
define('WEBURL','http://mtest.uz.com/');//网站域名
...
define('ATTACHMENT_URL','http://mtest.uz.com/uploadfile/');//附件路径
define('PHOTOS_ROOT',WWW_ROOT.'photosBox/');
define('PHOTOS_URL','http://mtest.uz.com/photosBox/');//附件路径
define('R','http://mtest.uz.com/res/');//静态文件存储目录
