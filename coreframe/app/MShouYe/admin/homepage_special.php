              ...
              if($keytypess==1){
               $where="status='1'";
                ...
                $where="status='3'";
                 ...
                 $result = $this->db->get_list('m_special',$where."and status!='4'", '*', 0, 10,$page,'addtime DESC,sort DESC');
          }else if($keytypes){
                $where="title like  '%".$GLOBALS['title']."%'";
                $result = $this->db->get_list('m_special',$where."and status!='4'", '*', 0, 10,$page,'addtime DESC,sort DESC');
          }else{
                if($GLOBALS['pai']=="tshang"){
                       $result = $this->db->get_list('m_special',"status!='4'", '*', 0, 10,$page,'addtime ASC');
                  }else if($GLOBALS['pai']=="txia"){
                       $result = $this->db->get_list('m_special',"status!='4'", '*', 0, 10,$page,'addtime DESC');
                       ...
                       $result = $this->db->get_list('m_special',"status!='4'", '*', 0, 10,$page,'addtime DESC,sort DESC');
                  }
