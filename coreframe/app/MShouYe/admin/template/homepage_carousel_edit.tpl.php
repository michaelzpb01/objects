...
<div role="tabpanel" class="tab-pane fade active in" id="tabs1" aria-labelledby="1tab">
      <form action="?m=MShouYe&f=homepage_carousel&v=edit<?php echo $this->su();?>" class="form-inline" method="post">
        <div class="input-group">
             ...
             <input type="checkbox" value="3360" name="city[]" class="input3" <?php if(in_array(3360,explode(',',$re['city']))){echo "checked='checked'";}?>>北京
             <input type="checkbox" class="input3" name="city[]" value="3362" <?php if(in_array(3362,explode(',',$re['city']))){echo "checked='checked'";}?>>天津
             <input type="checkbox" class="input3" name="city[]" value="328" <?php if(in_array(328,explode(',',$re['city']))){echo "checked='checked'";}?>>深圳
             <input type="checkbox" class="input3" name="city[]" value="326" <?php if(in_array(326,explode(',',$re['city']))){echo "checked='checked'";}?>>广州
             <input type="checkbox" class="input3" name="city[]" value="3361" <?php if(in_array(3361,explode(',',$re['city']))){echo "checked='checked'";}?>>上海
             <input type="checkbox" class="input3" name="city[]" value="435" <?php if(in_array(435,explode(',',$re['city']))){echo "checked='checked'";}?>>西安
             <input type="checkbox" class="input3" name="city[]" value="213" <?php if(in_array(213,explode(',',$re['city']))){echo "checked='checked'";}?>>杭州
              <input type="checkbox" class="input3" name="city[]" value="200" <?php if(in_array(200,explode(',',$re['city']))){echo "checked='checked'";}?>>南京<br/><br/>

             <span style="float:left;"><font style="color:red" size="2px">*</font><b><font size="2px">轮播图:</font></b>&nbsp;&nbsp;&nbsp;</span><input type="text" value="<?php echo $re['carousel'];?>" ondblclick="img_view('?m=core&f=image_privew&imgurl='+this.value);" class="form-control" id="attachment_test" name="attachment_test" size="100" style="width:450px;margin-right:5px;position:relative;">
