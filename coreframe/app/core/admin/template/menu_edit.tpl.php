                ...
                <div class="panel-body">
                    <form class="form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          <label class="col-sm-2 control-label">站点选择</label>
                             <div class="col-sm-6">
                              <? foreach($result as $site){?>
                             <input type="checkbox"  name="site[]" id="checkall" <?php  foreach ($sites as $key => $siteid) { if($site['siteid']==$siteid){echo 'checked';} }?> value="<?=$site['siteid'];?>"><?=$site['name'];?>
                             <?}?>
                          </div>
                       </div>
                        <div class="form-group">
