...
class index{
    ...
    public function init() {
		...
		if($where) {
			$seo_title = '北京市'.$kw_areaids.$kw_style.'装修公司_'.'北京市'.$kw_areaids.'专业的'.$kw_style.'装修公司 – 优装美家装修网';
			$seo_keywords = '北京市'.$kw_areaids.$kw_style.'装修公司,专业';
			$seo_description = '优装美家装修网涵盖了'.'北京市'.$kw_areaids.'所有的装修公司大全，了解'.'北京市'.$kw_areaids.'装修公司排名大全的所有装修公司，请关注优装美家装修网！ ';
		} else {
			$seo_title = '';
			$seo_keywords = '';
			$seo_description = '优装美家装修网涵盖了北京装修公司排名大全的所有装修公司，免费为您提供北京装修公司推荐的服务，了解北京十大装修公司排名，请关注优装美家装修网！';
		}
