<form name="myform" class="form-horizontal tasi-form" id="form6" action="?m=Mjin&f=company&v=interveneds&id=<?php echo $result['id']?><?php echo $this->su();?>" method="post">
<input name="intervene" id="zhi" value=" <?php echo $result['tese']?>">
